...
void alphaRadialDoseStandard(){
	...
	path1 = "root/simplified-ionrange-alpha-3_MeV-S4-withIon.root";	
	path2 = "root/simplified-ionrange-alpha-3_MeV-S4-withoutMsc.root";
	path3 = "root/simplified-ionrange-alpha-3_MeV-S4-withoutIon.root";
	path4 = "root/simplified-ionrange-alpha-3_MeV-S4-withoutMscIon.root";
