...
void protonRadialDose(){
	...
	pathDNA2 = "root/simplified-ionradial-proton-1_MeV-DNA2.root";	
	pathDNA4 = "root/simplified-ionradial-proton-1_MeV-DNA4.root";
	pathDNA6 = "root/simplified-ionradial-proton-1_MeV-DNA6.root";
	pathDNA8 = "root/simplified-ionradial-proton-1_MeV-DNA8.root";
	pathS4 = "root/simplified-ionradial-proton-1_MeV-S4.root";
	...
	for (size_t i=0; i<n; i++){
		...
		rmseDNA2 +=  TMath::Power(1-(graphDNA2->Eval(xData[i]))/yData[i], 2);
		rmseDNA4 +=  TMath::Power(1-(graphDNA4->Eval(xData[i]))/yData[i], 2);
		rmseDNA6 +=  TMath::Power(1-(graphDNA6->Eval(xData[i]))/yData[i], 2);
		rmseDNA8 +=  TMath::Power(1-(graphDNA8->Eval(xData[i]))/yData[i], 2);
		rmseS4	 +=  TMath::Power(1-(graphS4->Eval(xData[i]))/yData[i], 2);
	}
