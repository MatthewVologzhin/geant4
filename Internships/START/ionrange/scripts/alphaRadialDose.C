...
void alphaRadialDose(){
	...
	pathDNA2 = "root/simplified-ionrange-alpha-3_MeV-DNA2.root";	
	pathDNA4 = "root/simplified-ionrange-alpha-3_MeV-DNA4.root";
	pathDNA6 = "root/simplified-ionrange-alpha-3_MeV-DNA6.root";
	pathDNA8 = "root/simplified-ionrange-alpha-3_MeV-DNA8.root";
	pathS4 = "root/simplified-ionrange-alpha-3_MeV-S4.root";
