...
void Run::EndOfRun()
{
  ...
  if (constPhysList) {
      ...
      if (physList) {
          ...
          if (physicsListName == "dna_opt0") physName = "DNA";
          else if (physicsListName == "dna_opt2") physName = "DNA2";
          ...
          else if (physicsListName == "std_opt4"){
            physName = "S4";
            G4EmCalculator fpEmCalc;
            fSP = fpEmCalc.ComputeElectronicDEDX(fEkin, fParticle, material);
            rms = 0.;
          }
  ...
  G4String filename = "root/" + partName + '_' + physName + ".txt";
