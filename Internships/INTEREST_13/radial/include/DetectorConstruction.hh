...
class DetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    ...
    void SetCylinderNumber(const G4int&);
    void SetCylinderMinRadius(const G4double&);
    void SetCylinderMaxRadius(const G4double&);
    void SetCylinderLog(const G4bool&);

    G4LogicalVolume* GetCylinderLogical(G4int i) const {return fLogicCylinders[i];}
  ...
  private:
    ...
    G4int fCylinderNumber = 0;
    G4double fCylinderMinRadius = 0;
    G4bool fCylinderLog = false;
    ...
    std::vector<G4LogicalVolume*> fLogicCylinders;;
