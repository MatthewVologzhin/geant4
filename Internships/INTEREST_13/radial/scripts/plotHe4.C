...
void plotHe4()
{
	...
	parameters.paths["DNA2"]  = "root/RDD_alpha_3-MeV_DNA2.root";
	parameters.paths["DNA4"]  = "root/RDD_alpha_3-MeV_DNA4.root";
	parameters.paths["DNA6"]  = "root/RDD_alpha_3-MeV_DNA6.root";
	parameters.paths["DNA8"]  = "root/RDD_alpha_3-MeV_DNA8.root";
	parameters.paths["S4"]  = "root/RDD_alpha_3-MeV_S4.root";
...
const std::string FormCanvasName(std::string path){
	if (path.find("alpha") != std::string::npos) return "Radial dose distribution of alpha at energy E=1.5 MeV";
