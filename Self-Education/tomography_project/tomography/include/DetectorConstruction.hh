...
public:
	...
	G4double fDetectorLengthY, fDetectorLengthZ, fDetectorHeight;
	G4int numDetectorsY, numDetectorsZ;
	...
	G4int GetDetectorsNumY(){return numDetectorsY;};
	G4int GetDetectorsNumZ(){return numDetectorsZ;};
