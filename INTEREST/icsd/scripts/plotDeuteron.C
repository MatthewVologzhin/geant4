...
void plotDeuteron()
{
  /* Auxilary variables */
	...
	parameters.paths["S4"] 	  = "root/ICSD_deuteron_16-MeV_S4.root";
	...
	double authorsTextSize = 0.0255;
	authorsTextSize = 0.0252;
	...
	for (auto name : parameters.names){
		...
		XaxisRes->ChangeLabelByValue(16, -1, -1, -1, -1, -1, " "); // Delete label '100'
		XaxisRes->ChangeLabelByValue(18, -1, -1, -1, -1, -1, " "); // Delete label '100'
