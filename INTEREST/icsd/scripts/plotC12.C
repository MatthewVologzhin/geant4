...
void plotC12()
{
  /* Auxilary variables */
	...
	double yData[n] = {
		...
		0.09999999999999995, 0.09536333778926674, 0.08880831053642047, 0.07886916020333298,
	...
	parameters.paths["S4"] 	  = "root/ICSD_C12_88-MeV_S4.root";
	...
	for (auto name : parameters.names){
		...
		XaxisRes->ChangeLabelByValue(45, -1, -1, -1, -1, -1, " "); // Delete label '100'
